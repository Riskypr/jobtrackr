        ...
        <div className="rounded-[2.5rem] border border-slate-200/60 dark:border-slate-800/60 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl px-8 py-8 shadow-xl shadow-slate-200/20 dark:shadow-none">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <nav className="flex items-center gap-6 text-sm text-slate-500 dark:text-slate-400">
              <Link href="#hero" className="hover:text-blue-600 transition">
                Home
              </Link>
              <Link href="#ai-tools" className="hover:text-blue-600 transition">
                AI Tools
              </Link>
              <Link href="#features" className="hover:text-blue-600 transition">
                Features
              </Link>
              <Link href="#cta" className="hover:text-blue-600 transition">
                Get Started
              </Link>
            </nav>
